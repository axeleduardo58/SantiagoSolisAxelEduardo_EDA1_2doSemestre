/*Este programa consta de la realizacion de una calculadora por medio de un menu en la que el usuario
indicara la operacion que desea realizar y por ende la calculadora lo hara pidiendo los numeros individualmete 
para realizar la operacion y arrojando el resultado de esta */
